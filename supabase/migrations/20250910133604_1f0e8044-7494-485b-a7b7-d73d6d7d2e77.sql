...
CREATE TYPE product_category AS ENUM ('eletronicos', 'escritorio', 'limpeza', 'manutencao', 'outros', 'cozinha');
CREATE TYPE user_role AS ENUM ('admin', 'gerente', 'usuario', 'teste');
CREATE TYPE alert_type AS ENUM ('low_stock', 'expired', 'system', 'security');
