-- Add organization_id to security_audit_log table
...
-- Create trigger for product actions
...
-- Create trigger for movement actions
...
-- Create trigger for user membership actions
