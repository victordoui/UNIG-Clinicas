...
BEGIN
  FOR rec IN
    SELECT * FROM (VALUES
      ('44444444-4444-4444-4444-444444444444'::uuid, 'comprador1@teste.com', 'Emerson (Comprador 1)',  'compras'),
      ('55555555-5555-5555-5555-555555555555'::uuid, 'comprador2@teste.com', 'Renilson (Comprador 2)', 'compras'),
      ('66666666-6666-6666-6666-666666666666'::uuid, 'comprador3@teste.com', 'Leonardo (Comprador 3)', 'compras')
