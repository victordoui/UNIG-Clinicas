...
-- Índices
CREATE INDEX idx_invoices_org_id ON public.subscription_invoices(organization_id);
CREATE INDEX idx_invoices_status ON public.subscription_invoices(status);
CREATE INDEX idx_invoices_date ON public.subscription_invoices(billing_period_start DESC);
