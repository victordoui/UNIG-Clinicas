...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "Odontograma",
        url: "/especialidades?module=odontogram",
        icon: Stethoscope,
        clinicCode: "ODONTO",
      },
      {
        title: "Anamneses",
        url: "/especialidades?module=anamnesis",
        icon: ClipboardList,
        clinicCode: "ODONTO",
      },
      {
        title: "Planos de tratamento",
        url: "/especialidades?module=treatment-plans",
        icon: FileBadge,
        clinicCode: "ODONTO",
      },
      {
        title: "Procedimentos",
        url: "/procedimentos-exames?module=procedures",
        icon: ClipboardList,
        clinicCode: "ODONTO",
      },
      {
        title: "Evoluções",
        url: "/atendimentos?module=evolutions",
        icon: ScrollText,
        clinicCode: "ODONTO",
      },
      {
        title: "Exames e imagens",
        url: "/procedimentos-exames?module=exams",
        icon: FlaskConical,
        clinicCode: "ODONTO",
      },
      {
        title: "Documentos",
        url: "/documentos-consentimentos",
        icon: FileText,
        clinicCode: "ODONTO",
      },
    ],
  },
  {
    ...
    items: [
      {
        title: "Prontuários e avaliações",
        url: "/especialidades?module=physio-assessment",
        icon: FileText,
        clinicCode: "FISIO",
      },
      {
        title: "Avaliação funcional",
        url: "/especialidades?module=physio-functional",
        icon: Activity,
        clinicCode: "FISIO",
      },
      {
        title: "Planos terapêuticos",
        url: "/especialidades?module=physio-plans",
        icon: ClipboardList,
        clinicCode: "FISIO",
      },
      {
        title: "Sessões e evoluções",
        url: "/especialidades?module=physio-sessions",
        icon: ScrollText,
        clinicCode: "FISIO",
      },
      {
        title: "Reavaliações e alta",
        url: "/especialidades?module=physio-discharge",
        icon: FileBadge,
        clinicCode: "FISIO",
      },
    ],
  },
  {
    ...
    items: [
      {
        title: "Tutores e animais",
        url: "/veterinaria",
        icon: PawPrint,
        clinicCode: "VET",
      },
      {
        title: "Consultas e prontuários",
        url: "/veterinaria?module=consultations",
        icon: Stethoscope,
        clinicCode: "VET",
      },
      {
        title: "Vacinas",
        url: "/veterinaria?module=vaccines",
        icon: ClipboardList,
        clinicCode: "VET",
      },
      {
        title: "Exames e prescrições",
        url: "/veterinaria?module=exams",
        icon: FlaskConical,
        clinicCode: "VET",
      },
      {
        title: "Internação",
        url: "/veterinaria?module=hospitalization",
        icon: Building2,
        clinicCode: "VET",
      },
    ],
    ...
    items: [
      {
        ...
        url: "/especialidades?module=aesthetic-assessment",
        icon: FileText,
        clinicCode: "ESTETICA",
      },
      {
        title: "Avaliação estética",
        url: "/especialidades?module=aesthetic-evaluation",
        icon: Stethoscope,
        clinicCode: "ESTETICA",
      },
      {
        title: "Protocolos e sessões",
        url: "/especialidades?module=aesthetic-protocols",
        icon: ClipboardList,
        clinicCode: "ESTETICA",
      },
      {
        title: "Registro fotográfico",
        url: "/especialidades?module=aesthetic-photos",
        icon: FileBadge,
        clinicCode: "ESTETICA",
      },
    ],
  },
  {
    ...
    section: "ENSINO / SUPERVISÃO",
    label: "Ensino e supervisão",
    icon: GraduationCap,
    roles: [
      "super_admin",
      "administrador",
    ...
    items: [
      ...
      { title: "Professores", url: "/academico/professores", icon: BookOpen },
      {
        ...
        url: "/supervisoes?status=pending",
        icon: ClipboardList,
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      { title: "Materiais e insumos", url: "/estoque", icon: Package },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "Salas Livres",
        url: "/academico/salas-livres",
        icon: MapPinned,
      },
      {
        title: "Pendências",
        url: "/academico/pendencias",
        icon: ClipboardList,
        badge: 3,
      },
      {
        title: "Análise de Ensalamento",
        url: "/academico/analise-ensalamento",
        icon: BarChart3,
      },
  ...
  },
  {
    ...
    items: [
      {
        title: "Fila de Requerimentos",
        url: "/atendimento/requerimentos",
        icon: ClipboardList,
        badge: 3,
      },
      {
        title: "Histórico do Aluno",
        url: "/atendimento/historico",
        icon: ScrollText,
      },
    ],
  },
  {
    ...
    items: [
      {
        title: "Comunicados",
        url: "/comunicacao/comunicados",
        icon: Megaphone,
      },
      {
        title: "Notificações",
        url: "/comunicacao/notificacoes",
        icon: Bell,
        badgeKey: "notifications",
      },
      {
        title: "Mensagens",
        url: "/comunicacao/mensagens",
        icon: MessageSquare,
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      {
        title: "Acadêmicos",
        url: "/relatorios/academicos",
        icon: GraduationCap,
      },
      {
        title: "Operacionais",
        url: "/relatorios/operacionais",
        icon: BarChart3,
      },
      {
...
export function AppSidebar() {
  ...
  const menuClinicCodes = activeClinicCode
    ? [activeClinicCode]
    : availableClinicCodes;
  const visibleGroups = useMemo(
    () =>
      NAV_GROUPS.filter(
        (group) =>
          CLINICAL_NAVIGATION_GROUPS.has(group.id) &&
          group.roles.includes(unigRole),
      )
        .map((group) => ({
          ...group,
          items: group.items.filter((item) => {
            if (item.clinicCode && !menuClinicCodes.includes(item.clinicCode))
              return false;
            if (
              item.clinicCodes &&
              !item.clinicCodes.some((code) => menuClinicCodes.includes(code))
            )
              return false;
            return true;
          }),
  ...
  useLayoutEffect(() => {
    ...
    const savedPosition =
      sidebarScrollMemory.get(scrollStorageKey) ??
          ...
          {!collapsed && (
            <div className="mt-4 flex w-full items-center gap-2 rounded-xl border border-white/15 bg-white/[0.07] px-3 py-2 text-xs font-semibold text-white/90">
              ...
              <select
                ...
                value={activeClinicCode ?? ""}
                onChange={(event) =>
                  setActiveClinicCode(event.target.value || null)
                }
                className="min-w-0 flex-1 cursor-pointer appearance-none bg-transparent text-center outline-none"
              >
                ...
                {availableClinicCodes.map((code) => (
                  <option key={code} value={code} className="text-foreground">
                    {CLINIC_LABELS[code] ?? code}
                  </option>
                ))}
              </select>
                      ...
                      {group.items.map((item) => {
                        ...
                        return (
                          <SidebarMenuItem key={item.url}>
                            ...
                            {badge ? (
                              <SidebarMenuBadge className="right-2 top-2.5 h-[19px] min-w-[19px] rounded-full bg-[#ff4b55] px-1 text-[10px] font-extrabold text-white">
                                {badge > 99 ? "99+" : badge}
                              </SidebarMenuBadge>
                            ) : null}
                          </SidebarMenuItem>
