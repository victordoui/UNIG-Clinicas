...
import Indicadores from './pages/reporting/Indicadores';
      ...
      <AuthProvider>
        <TooltipProvider>
          ...
          <Routes>
            ...
            <Route path="/admin/logs" element={<ProtectedRoute allowRoles={[...ADMIN_ROLES, 'financeiro']}><AdminLogs /></ProtectedRoute>} />
