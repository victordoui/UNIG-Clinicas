...
export const DEMO_USERS: DemoUser[] = [
  ...
  {
    role: 'atendimento',
    email: 'receptionist-teste-odonto@unig.demo',
    password: DEMO_PASSWORD,
    label: 'Recepção e fila — posto 2',
  ...
  {
    role: 'paciente',
    email: 'patient-teste-odonto-1@unig.demo',
    password: DEMO_PASSWORD,
    label: 'Paciente teste 1 — Odonto',
    accessGroup: 'Clínica de Odontologia — Portal do cliente',
    clinicCode: 'ODONTO',
    clinicName: 'Clínica de Odontologia',
    patientDocument: 'demo-005',
  },
  {
    role: 'paciente',
    email: 'patient-teste-odonto-2@unig.demo',
    password: DEMO_PASSWORD,
    label: 'Paciente teste 2 — Odonto',
    accessGroup: 'Clínica de Odontologia — Portal do cliente',
    clinicCode: 'ODONTO',
    clinicName: 'Clínica de Odontologia',
    patientDocument: 'demo-006',
  },
  {
    role: 'tutor',
